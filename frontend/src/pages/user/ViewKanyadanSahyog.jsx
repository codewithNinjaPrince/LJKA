      ...
      <div className="w-full max-w-2xl text-center">
        <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-8 sm:p-12">
          ...
          <p className="text-gray-600 text-sm sm:text-base leading-relaxed max-w-xl mx-auto">
            The Kanyadan Sahyog details and support section is currently under
            development. It will be available soon through your LJKA member
            portal.
          </p>
...
export default ViewKanyadanSahyog;

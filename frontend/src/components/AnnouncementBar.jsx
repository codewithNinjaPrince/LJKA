...
const AnnouncementBar = () => {
  const messages = [
    ...
    <>
      Join the LJKA community and become a part of{" "}
      <span className="font-bold text-[var(--ljka-gold-dark)]">
        collective support
      </span>
    </>,
  ...
  return (
    <div className="relative w-full overflow-hidden border-b border-[var(--ljka-border)] bg-[var(--ljka-primary-bg)] shadow-sm">
      ...
      <style>{`
        ...
        @keyframes ljka-gold-glow {
          ...
          50% {
            box-shadow: 0 0 18px rgba(200, 162, 74, .25);
          }
        }
      ...
      <div className="flex h-9 items-center sm:h-10">
        ...
        {/* NOTICE SECTION */}
        <div className="relative z-20 flex h-full shrink-0 items-center border-r border-[var(--ljka-border)] bg-[var(--ljka-gold-light)] px-3 sm:px-4">

          <div className="ljka-notice-badge flex items-center gap-2 rounded-full border border-[var(--ljka-gold)]/50 bg-white/40 px-2.5 py-1 backdrop-blur-sm sm:px-3">

            <span className="relative flex h-2 w-2 items-center justify-center">

              <span className="ljka-notice-dot absolute h-2 w-2 rounded-full bg-[var(--ljka-primary)]" />

              <span className="relative h-1.5 w-1.5 rounded-full bg-[var(--ljka-primary)]" />

            </span>

            <FaBullhorn className="text-[10px] text-[var(--ljka-primary)] sm:text-xs" />

            <span className="hidden text-[9px] font-bold uppercase tracking-[0.14em] text-[var(--ljka-primary)] sm:block">
              Notice
            </span>
        ...
        {/* MARQUEE */}
        <div className="ljka-announcement-wrap relative min-w-0 flex-1 overflow-hidden bg-[var(--ljka-primary-bg)]">

          {/* LEFT FADE */}
          <div className="pointer-events-none absolute left-0 top-0 z-10 h-full w-10 bg-gradient-to-r from-[var(--ljka-primary-bg)] to-transparent sm:w-16" />

          {/* RIGHT FADE */}
          <div className="pointer-events-none absolute right-0 top-0 z-10 h-full w-10 bg-gradient-to-l from-[var(--ljka-primary-bg)] to-transparent sm:w-16" />


          <div className="ljka-announcement-track flex w-max items-center whitespace-nowrap py-2 text-[11px] font-medium text-[var(--ljka-primary)] sm:text-xs">
            ...
            {[...messages, ...messages].map((message, index) => (
              ...
              <React.Fragment key={index}>
                ...
                <span
                  className="inline-flex items-center text-[9px] text-[var(--ljka-gold)] sm:text-[10px]"
                  aria-hidden="true"
                >
                  <FaStar />
                </span>
        ...
        {/* RIGHT ACCENT */}
        <div className="hidden h-full shrink-0 items-center border-l border-[var(--ljka-border)] bg-[var(--ljka-bg)] px-4 sm:flex">

          <span className="flex items-center gap-1.5 text-[9px] font-bold uppercase tracking-[0.14em] text-[var(--ljka-primary)]/70">
